...
let montantEmprunte = 1000000
let dureeEnMois = 24
let revenuMensuel = 20000
let mensualite = montantEmprunte / dureeEnMois

if(montantEmprunte / dureeEnMois < revenuMensuel / 100 * 30){
    console.log("tu n'est pas eligible")
}
else if(montantEmprunte / dureeEnMois >= revenuMensuel / 100 * 30){
    console.log("pret accorde mensualite" + " " + Math.floor(mensualite))
}
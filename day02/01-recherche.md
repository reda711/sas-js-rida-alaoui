...
**Ma réponse :** on utilise une boucle for pour répéter un code un nombre de fois , pour while la boucle coutinuer a répéter infini tant qu' une condition est vrai
...
**Ma réponse :** do while execute le code au mois une seul fois 
...
**Ma réponse :**ca cause une boucle infinie
...
**Ma réponse :**pour arreter la boucle immediatement
...
**Ma réponse :**ignoer l’itération actualle et passer diricetement au l’itération suivante 
...
**Ma réponse :**initialisation puis condition puis incrémentation  
...
**Ma réponse :** boucle a l'interior d'une boucle 
